...
: io. ( pin -- )  \ display readable GPIO registers associated with a pin
  ...
  io-base
    ."  MODER " dup @ hex. 4 +
  cr $0D spaces ." OTYPER " dup @ h.4  4 +
  cr $0C spaces  ." OSPEEDR " dup @ hex. 4 +
  cr $0F spaces  ." PUPD " dup @ hex. 4 +
  cr $10 spaces  ." IDR " dup @ h.4  4 +
  cr $10 spaces  ." ODR " dup @ h.4  12 +
  cr $0F spaces  ." AFRL " dup @ hex. 4 +
  cr $0F spaces  ." AFRH " dup @ hex. drop
;
